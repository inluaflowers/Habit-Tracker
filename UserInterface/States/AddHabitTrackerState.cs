...
public sealed class AddHabitTrackerState : BaseState
{
    ...
    public override void BuildMenuStates()
    {
        ...
        {
            AddMenuStateAction(MenuEnum.Value, key => new InputState<AddHabitTrackerState>(key), "Habit Name", "None");
            AddMenuStateAction(MenuEnum.Value, key => new InputState<AddHabitTrackerState>(key), "Base Unit of Measurement", "None");
